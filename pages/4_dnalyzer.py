        ...
        ">
            ...
            ">
                ...
                <button
                    id="btn-finish"
                    class="action-btn"
                    onclick="seekAndShow(5.4, 'finish')"
                >
                    🏁 收拍結尾
                </button>
