...
def show_help_dialog():
    current_dir = os.path.dirname(os.path.abspath(__file__))
    video_path = os.path.join(current_dir, "IMG_0285.mp4")
...
if uploaded_file:
    ...
    if len(records) > 10:
        ...
        # 標準動作
        # -------------------------
        csv_path = os.path.join(current_dir, "standard_backhand_clear.csv")
